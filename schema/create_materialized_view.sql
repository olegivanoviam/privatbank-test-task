...
-- Create materialized view for customer totals by customer_id and operation_type (idempotent)
...
CREATE INDEX IF NOT EXISTS idx_customer_totals_transaction_count ON customer_totals (transaction_count);
